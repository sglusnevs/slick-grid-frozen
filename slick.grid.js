...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
            ...
            columnElements.each(function (i, e) {
                ...
                $("<div class='slick-resizable-handle' />")
                    ...
                    .bind("dragstart",function (e, dd) {
                        ...
                        // after migration to jQuery 3.x, e.pageX stopped working, so I had to register mousemove global handler in this.init()
                        // pageX = e.pageX;
                        ...
                        var actualMinWidth, d = Math.min(maxPageX, Math.max(minPageX, $currentMousePos.x)) - pageX,
                            x;
        ...
        $.extend(this, {
            ...
            "onCellChangeCustom": new Slick.Event(),
